...
const IMG_ORI = 'https://i.imgur.com/EW0IV65.jpg';
const IMG_DIF = 'https://i.imgur.com/x2NcFMR.jpg';
const RES_WIDTH = '1323px';
const RES_HEIGHT = '536px';
const RES_WIDTH_STATIC = '734px';
const RES_HEIGHT_STATIC = '144px';

export default function HiddenObj2() {
    ...
    const [coords, setCoords] = useState([
        ...
        {
            slashpos: 300,
            coordObj: [590, 160, 100],
            found: false
        },
        {
            slashpos: 455,
            coordObj: [610, 270, 120],
            found: false
        },
        {
            slashpos: 630,
